...
class SPPFCSPC_jzt(nn.Module):
    
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=5):
        super(SPPFCSPC_jzt, self).__init__()
...
class ContextAggregation11(nn.Module):
    """
    ...
    def __init__(self, in_channels, reduction=1):
        super(ContextAggregation11, self).__init__()
        self.in_channels = in_channels
